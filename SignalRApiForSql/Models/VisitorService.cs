...
namespace SignalRApiForSql.Models
{
    public class VisitorService
    {
        ...
        public List<VisitorCharts> GetVisitorChartList()
        {
            ...
            {
                command.CommandText = @"
Select tarih,[1],[2],[3],[4],[5] from(select[City],[CityVisitCount], CAST([VisitDate] as
Date) as tarih from Visitors) as visitTable Pivot(Sum(CityVisitCount) For City in ([1],[2],[3],[4],[5]))
